...
public class EnclaveMain implements ModInitializer {
	...
	// ToolMaterial
	private static final ClaveMaterial material = new ClaveMaterial(1, 0, 0.5F, 2.5F, 750, () -> {return Ingredient.ofItems(EnclaveMain.steel);});
	...
	// Tools
	public static final WeaponItem batonweap = new WeaponItem(material, 2, 0.5F, new Item.Settings().group(EnclaveMain.ENCLAVEWEAP).maxCount(1).maxDamage(450));
